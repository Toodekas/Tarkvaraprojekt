...
const VictimTableComments = props => {
    const { classes } = props;
                ...
                <TableBody>
                    {props.victims.map(row => {
                        ...
                        return (
                                <TableRow 
                                    hover
                                    onClick={e => window.open( "/victim/" + n.id + "/"+ n.incident_id + "/" + n.session_id)}
                                    key={n.id}
                                >
                                    ...
                                    <TableCell>{n.kirjeldus}</TableCell>
                                </TableRow>
                        );
                    })}
                </TableBody>
...
VictimTableComments.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default VictimTableComments;